...
internal static class ThemeService
{
    ...
    static readonly IReadOnlyDictionary<string, string> DarkPalette = new Dictionary<string, string>
    {
        ...
        ["GestureRowHoverBackground"] = "#34383D",
        ...
        ["WarningBrush"] = "#FFD60A",
        ["DangerBrush"] = "#E05A63",
        ["DangerBackground"] = "#C63D47",
        ["DangerHoverBackground"] = "#D94B55",
    ...
    static readonly IReadOnlyDictionary<string, string> LightPalette = new Dictionary<string, string>
    {
        ...
        ["GestureRowHoverBackground"] = "#DEE8E6",
        ...
        ["WarningBrush"] = "#9A6700",
        ["DangerBrush"] = "#C43A46",
        ["DangerBackground"] = "#D13D49",
        ["DangerHoverBackground"] = "#B92F3B",
        ["DangerForeground"] = "#FFFFFF",
        ["DangerHoverForeground"] = "#FFFFFF",
