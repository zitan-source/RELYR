...
public static class SelfTest
{
    public static int Run(TextWriter output)
    {
        ...
        try
        {
            ...
            Check(MainWindow.ShouldUiHostInterceptInput(false, true, false) && !MainWindow.ShouldUiHostInterceptInput(false, true, true) && MainWindow.ShouldUiHostInterceptInput(true, true, true), "the UI input hook falls back for an elevated foreground when the helper is unavailable and retains captured layers through release");
