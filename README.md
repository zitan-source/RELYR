...
RELYR is provided under the MIT License. A concise, localized summary of safe configuration, warranty disclaimer, and limitation of liability is shown before a fresh installation can continue. Normal updates do not repeat the same terms after acceptance. See the [terms of use](TERMS.md).
