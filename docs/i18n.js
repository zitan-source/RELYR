(() => {
  const translations = {
    'ja-JP': {
      native: '日本語', beta: '公開ベータ', feedback: '使い方・感想を送る', guide: '3分で始める', title: 'RELYR — キーボードを、拡張する。',
    ...
    'en-US': {
      native: 'English', beta: 'Public Beta', feedback: 'Share feedback', guide: 'Three-minute guide', title: 'RELYR — Extend your keyboard.',
    ...
    'zh-CN': {
      native: '简体中文', beta: '公开测试版', feedback: '分享反馈', guide: '三分钟入门', title: 'RELYR — 扩展你的键盘。',
    ...
    'zh-TW': {
      native: '繁體中文', beta: '公開測試版', feedback: '分享意見', guide: '三分鐘入門', title: 'RELYR — 擴充你的鍵盤。',
    ...
    'ko-KR': {
      native: '한국어', beta: '공개 베타', feedback: '피드백 보내기', guide: '3분 시작 가이드', title: 'RELYR — 키보드를 확장하세요.',
    ...
    'fr-FR': {
      native: 'Français', beta: 'Bêta publique', feedback: 'Donner un avis', guide: 'Guide de démarrage', title: 'RELYR — Étendez votre clavier.',
    ...
    'de-DE': {
      native: 'Deutsch', beta: 'Öffentliche Beta', feedback: 'Feedback geben', guide: 'Schnellstart', title: 'RELYR — Erweitere deine Tastatur.',
    ...
    'es-ES': {
      native: 'Español', beta: 'Beta pública', feedback: 'Compartir opinión', guide: 'Guía de inicio', title: 'RELYR — Amplía tu teclado.',
